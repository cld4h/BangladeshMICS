---
title: Laplace Prior - Bayesian Hierarchical Generalized Poisson Model
---
...
for(s in 1:S)
{
  ...
  K_alpha[55] <- 20
	...
	lr <- lr + sum( dlaplace(theta.p, pmn.theta, psd.theta, log=T)) -sum(dlaplace(THETA, pmn.theta, psd.theta, log=T))
	#print("lr is")
	#print(lr)
...
```{r eval=FALSE}
RESULTPATH = "./data_output/BHGP.Laplace/"
