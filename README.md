## Bayesian hierarchical generalized Poisson regression on Bangladesh MICS dataset
...
Please refer to `wm.sav` and `hh.sav` for data used in this research project.
