...
legend("topright", legend = c("Relative frequency", expression(paste("Poisson (",mu,"=2)",sep="")), expression(paste("Generalized Poisson (", mu," = 2, ",alpha, " = -0.09)", sep="" ))), col=xcol,
       lwd = 6, text.font = 2 )
...
```{r}
x <- 0:12
mu <- c(2.3, 2.3, 2.3, 2.3, 2.3, 2.3, 2.3)
...
legend(7,0.3,
	c(
		expression(paste(mu, " = 2.3, ", alpha," = -0.10")),
		expression(paste(mu, " = 2.3, ", alpha," = -0.06")),
		expression(paste(mu, " = 2.3, ", alpha," = -0.03")),
		expression(paste(mu, " = 2.3, ", alpha," =   0.00")),
		expression(paste(mu, " = 2.3, ", alpha," =   0.03")),
		expression(paste(mu, " = 2.3, ", alpha," =   0.06")),
		expression(paste(mu, " = 2.3, ", alpha," =   0.10"))
