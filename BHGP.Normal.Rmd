---
title: Normal Prior - Bayesian Hierarchical Generalized Poisson Model
---
...
for(s in 1:S)
{
  ...
  K_alpha[55] <- 20
	...
	lr <- lr + sum( dnorm(theta.p, pmn.theta, psd.theta, log=TRUE)) - sum(dnorm(THETA, pmn.theta, psd.theta, log=TRUE))
	#print("lr is")
	#print(lr)
...
```{r eval=FALSE}
RESULTPATH = "./data_output/BHGP.Normal/"
